...
Planned Mission Order ID: P3-WS-001-MO-002-MISSION-ORDER-GOVERNANCE-CONTROL

Mission Order Name: Mission Order Governance Control

Target Lot: LOT-002

Source Document: P3_WS_001_MISSION_ORDER_PLAN.md

Extraction Mission ID: P3-WS-001-MO-002-EXTRACTION
...
This document extracts the second Mission Order defined in `P3_WS_001_MISSION_ORDER_PLAN.md`.
...
The second Mission Order in `P3_WS_001_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Planned Mission Order ID | P3-WS-001-MO-002-MISSION-ORDER-GOVERNANCE-CONTROL |
| Target lot | LOT-002 |
| Purpose | Define the minimum required contents and gates for future development Mission Orders. |
| Dependencies | MO-001 complete or formally blocked. |
