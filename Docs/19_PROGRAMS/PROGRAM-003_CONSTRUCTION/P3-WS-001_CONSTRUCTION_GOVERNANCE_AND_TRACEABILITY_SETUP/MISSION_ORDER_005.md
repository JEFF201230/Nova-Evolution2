...
Planned Mission Order ID: P3-WS-001-MO-005-BOARD-GATE-CONTROL

Mission Order Name: Board Gate Control

Target Lot: LOT-005

Source Document: P3_WS_001_MISSION_ORDER_PLAN.md

Extraction Mission ID: P3-WS-001-MO-005-EXTRACTION
...
This document extracts the fifth Mission Order defined in `P3_WS_001_MISSION_ORDER_PLAN.md`.
...
The fifth Mission Order in `P3_WS_001_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Planned Mission Order ID | P3-WS-001-MO-005-BOARD-GATE-CONTROL |
| Target lot | LOT-005 |
| Purpose | Define Review Board, Architecture Board, Engineering Board, and Certification Board checkpoints. |
| Dependencies | MO-004 complete or formally blocked. |
