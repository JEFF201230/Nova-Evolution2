...
Planned Mission Order ID: P3-WS-001-MO-004-EVIDENCE-AND-TEST-CONTROL

Mission Order Name: Evidence And Documentary Test Control

Target Lot: LOT-004

Source Document: P3_WS_001_MISSION_ORDER_PLAN.md

Extraction Mission ID: P3-WS-001-MO-004-EXTRACTION
...
This document extracts the fourth Mission Order defined in `P3_WS_001_MISSION_ORDER_PLAN.md`.

This document does not open MO-004.

This document does not execute MO-004.
...
The fourth Mission Order in `P3_WS_001_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Planned Mission Order ID | P3-WS-001-MO-004-EVIDENCE-AND-TEST-CONTROL |
| Target lot | LOT-004 |
| Purpose | Define mandatory evidence and documentary test criteria for future construction deliveries. |
| Dependencies | MO-003 complete or formally blocked. |
...
The source plan places MO-004 in the following sequence:
...
## 4. Source Plan Rules Applicable To MO-004
