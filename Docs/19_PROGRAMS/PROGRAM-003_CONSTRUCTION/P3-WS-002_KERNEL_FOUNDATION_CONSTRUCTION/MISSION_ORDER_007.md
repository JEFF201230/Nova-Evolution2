...
Planned Mission Order ID: P3-WS-002-MO-007-BOARD-GATE-CONTROL
...
Extraction Mission ID: P3-WS-002-MO-007-EXTRACTION
...
This document extracts the seventh Mission Order defined in `P3_WS_002_MISSION_ORDER_PLAN.md`.
...
The seventh Mission Order in `P3_WS_002_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Target lot | LOT-007 |
| Nature | Governance |
| Purpose | Define Review Board, Engineering Board, Architecture Board, and Certification Board checkpoints. |
| Dependencies | MO-006 complete or formally blocked with accepted disposition. |
| Produces code | NO |
