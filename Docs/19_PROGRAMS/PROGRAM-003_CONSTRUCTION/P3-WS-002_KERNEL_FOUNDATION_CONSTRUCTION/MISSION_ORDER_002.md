...
Planned Mission Order ID: P3-WS-002-MO-002-KERNEL-BASELINE-CONFORMANCE-MAPPING

Mission Order Name: Kernel Baseline Conformance Mapping
...
Extraction Mission ID: P3-WS-002-MO-002-EXTRACTION
...
This document extracts the second Mission Order defined in `P3_WS_002_MISSION_ORDER_PLAN.md`.

This document does not open MO-002.

This document does not execute MO-002.
...
The second Mission Order in `P3_WS_002_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Target lot | LOT-002 |
| Nature | Governance |
| Purpose | Map future Kernel foundation work to Kernel Baseline v1.0 preservation requirements. |
| Dependencies | MO-001 complete or formally blocked with accepted disposition. |
| Produces code | NO |
...
The source plan places MO-002 in the following sequence:
...
## 4. Source Plan Rules Applicable To MO-002
