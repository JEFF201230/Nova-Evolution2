...
Planned Mission Order ID: P3-WS-002-MO-006-EVIDENCE-AND-TEST-CONTROL

Mission Order Name: Evidence And Test Control

Target Lot: LOT-006

Mission Nature: Verification

Source Document: P3_WS_002_MISSION_ORDER_PLAN.md

Extraction Mission ID: P3-WS-002-MO-006-EXTRACTION
...
This document extracts the sixth Mission Order defined in `P3_WS_002_MISSION_ORDER_PLAN.md`.
...
The sixth Mission Order in `P3_WS_002_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Target lot | LOT-006 |
| Nature | Verification |
| Purpose | Define evidence inventory, test criteria, acceptance checks, and SHA-256 requirements for future construction deliverables. |
| Dependencies | MO-005 complete or formally blocked with accepted disposition. |
| Produces code | NO |
