...
Planned Mission Order ID: P3-WS-002-MO-008-CERTIFICATION-CAPITALIZATION-ARCHIVE-CONTROL

Mission Order Name: Certification Capitalization Archive Control

Target Lot: LOT-008

Mission Nature: Certification

Source Document: P3_WS_002_MISSION_ORDER_PLAN.md

Extraction Mission ID: P3-WS-002-MO-008-EXTRACTION
...
This document extracts the eighth Mission Order defined in `P3_WS_002_MISSION_ORDER_PLAN.md`.

This document does not open MO-008.

This document does not execute MO-008.
...
The eighth Mission Order in `P3_WS_002_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Purpose | Define Workstream certification, capitalization, archive readiness, and closure readiness controls. |
| Dependencies | MO-007 complete or formally blocked with accepted disposition. |
| Produces code | NO |
...
The source plan places MO-008 in the following sequence:
...
## 4. Source Plan Rules Applicable To MO-008
