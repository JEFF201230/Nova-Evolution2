...
Planned Mission Order ID: P3-WS-002-MO-005-KERNEL-CONSTRUCTION-MILESTONE-CONTROL

Mission Order Name: Kernel Construction Milestone Control
...
Extraction Mission ID: P3-WS-002-MO-005-EXTRACTION
...
This document extracts the fifth Mission Order defined in `P3_WS_002_MISSION_ORDER_PLAN.md`.

This document does not open MO-005.

This document does not execute MO-005.
...
The fifth Mission Order in `P3_WS_002_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Target lot | LOT-005 |
| Nature | Governance |
| Purpose | Define milestone gates for later authorized Kernel Foundation construction without implementation detail. |
| Dependencies | MO-004 complete or formally blocked with accepted disposition. |
| Produces code | NO |
...
The source plan places MO-005 in the following sequence:
...
## 4. Source Plan Rules Applicable To MO-005
