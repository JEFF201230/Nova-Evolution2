...
Planned Mission Order ID: P3-WS-002-MO-003-KERNEL-SERVICES-TRACEABILITY-MAPPING

Mission Order Name: Kernel Services Traceability Mapping
...
Extraction Mission ID: P3-WS-002-MO-003-EXTRACTION
...
This document extracts the third Mission Order defined in `P3_WS_002_MISSION_ORDER_PLAN.md`.
...
The third Mission Order in `P3_WS_002_MISSION_ORDER_PLAN.md` is reproduced below.
...
| Target lot | LOT-003 |
| Nature | Governance |
| Purpose | Map PROGRAM-002 WS-003 Kernel Services corpus to future construction evidence and tests. |
| Dependencies | MO-002 complete or formally blocked with accepted disposition. |
| Produces code | NO |
