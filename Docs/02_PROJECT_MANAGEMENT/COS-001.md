...
Identifiant du lot : COS-001

Titre du lot : Creation du README officiel de CEREBRAU Operating System
...
Creer le README officiel de CEREBRAU Operating System.
...
CEREBRAU Operating System est l'espace documentaire dedie a l'organisation, a la gouvernance et au pilotage du systeme CEREBRAU.

Le README officiel doit presenter la mission de CEREBRAU Operating System, son positionnement dans CEREBRAU, son perimetre, son organisation generale et ses principaux documents de gouvernance.

Le README ne doit contenir aucune regle d'execution, celles-ci etant portees par MASTER_EXECUTION_SPECIFICATION.md.
...
- creer Docs/09_CEREBRAU OPERATING SYSTEM/README.md ;
- creer Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-001.md.
...
- Docs/09_CEREBRAU OPERATING SYSTEM/README.md
- Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-001.md
...
- Docs/09_CEREBRAU OPERATING SYSTEM/MASTER_EXECUTION_SPECIFICATION.md
- Docs/09_CEREBRAU OPERATING SYSTEM/LOT_TEMPLATE.md
- tout fichier autre que Docs/09_CEREBRAU OPERATING SYSTEM/README.md
- tout fichier autre que Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-001.md
...
- README officiel de CEREBRAU Operating System presentant la mission, le positionnement, le perimetre, l'organisation generale et les principaux documents de gouvernance ;
- document de lot COS-001 conforme a LOT_TEMPLATE.md.
...
- le README ne contient aucune regle d'execution ;
- le README reference les principaux documents de gouvernance sans modifier ces documents.
...
- COS-001.md est cree conformement a LOT_TEMPLATE.md ;
- README.md est cree ou complete conformement a l'objectif.
...
- creation du document de lot COS-001 ;
- creation du README officiel de CEREBRAU Operating System.
