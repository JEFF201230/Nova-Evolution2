...
Identifiant du lot : COS-004

Titre du lot : Creation du registre officiel des programmes
...
Creer le registre officiel des programmes de CEREBRAU Operating System.
...
CEREBRAU Operating System doit disposer d'un registre officiel des programmes.

Le registre doit definir la structure officielle des Programmes et initialiser le premier programme : PROGRAM-001, CEREBRAU Operating System Foundation.

Ce programme regroupe les travaux fondateurs de CEREBRAU Operating System.
...
- creer Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-004.md ;
- creer Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/PROGRAM_REGISTER.md.
...
- Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-004.md
...
- Docs/09_CEREBRAU OPERATING SYSTEM/LOT_TEMPLATE.md
- Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/LOT_REGISTER.md
- tout fichier autre que Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-004.md
- tout fichier autre que Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/PROGRAM_REGISTER.md
...
- document de lot COS-004 conforme a LOT_TEMPLATE.md ;
- registre officiel des programmes contenant la structure officielle des Programmes et l'entree PROGRAM-001.
...
- LOT_REGISTER.md ne doit pas etre modifie ;
- les documents de gouvernance ne doivent pas etre modifies.
...
- COS-004.md respecte LOT_TEMPLATE.md ;
- PROGRAM_REGISTER.md est cree ;
- PROGRAM-001 est enregistre ;
...
- la structure des programmes est incomplete.
...
- creation du document de lot COS-004 ;
- creation du registre officiel des programmes.
