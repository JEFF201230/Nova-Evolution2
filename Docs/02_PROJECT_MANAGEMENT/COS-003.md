...
Identifiant du lot : COS-003

Titre du lot : Creation du registre officiel des lots
...
Creer le registre officiel des lots de CEREBRAU Operating System.
...
Le registre officiel des lots constitue la source de suivi des lots de CEREBRAU Operating System.

Le registre doit contenir une table permettant de suivre chaque lot avec les colonnes obligatoires definies par la mission.

Le registre doit etre initialise avec les lots deja valides COS-000C, COS-001 et COS-002.
...
- creer Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-003.md ;
- creer ou modifier Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/LOT_REGISTER.md.
...
- Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-003.md
...
- tout fichier autre que Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/COS-003.md
- tout fichier autre que Docs/09_CEREBRAU OPERATING SYSTEM/02_PROJECT_MANAGEMENT/LOT_REGISTER.md
...
- document de lot COS-003 conforme a LOT_TEMPLATE.md ;
- registre officiel des lots contenant les colonnes obligatoires et les entrees COS-000C, COS-001 et COS-002.
...
- le registre doit contenir les colonnes obligatoires ;
- les lots existants ne doivent pas etre modifies.
...
- COS-003.md respecte LOT_TEMPLATE.md ;
- LOT_REGISTER.md est cree ;
- les trois lots valides COS-000C, COS-001 et COS-002 sont enregistres ;
- aucun lot existant n'est modifie.
...
- un lot existant est altere ;
- le registre est incomplet.
...
- creation du document de lot COS-003 ;
- creation du registre officiel des lots.
