# CONFIRM — Dependencies and Reuse
...
|---|---|---|---|
| Appelante | Plan Setup | Review and start | T034 |
| Appelée | Plan Setup | Back | T036 |
| Appelée | Work | Start work | T037 |
| Réutilisation | OptionButton, Card, ConfChip, Btn | Patterns partagés | NOVA_SHARED_COMPONENTS |
