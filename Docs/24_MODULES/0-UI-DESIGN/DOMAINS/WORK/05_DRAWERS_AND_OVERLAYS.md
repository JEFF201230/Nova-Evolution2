...
|---|---|---|---|---|---|
| Search Overlay | Overlay global | Search/Cmd-Ctrl+K | Escape/backdrop | DOC | T006-T007 |
| Drawers Work | Full Analysis, Person, Source, Deliverable selon tab | CTA contextuel | X/backdrop; Escape/focus ND | DOC+UX partiel | DR02-DR05 |
| ConfChip | Popover | Clic chip | X | DOC+UX | T046 |
